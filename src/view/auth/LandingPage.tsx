...
<Wrapper className="main-signin">
         ...
         <nav className="navbar navbar-standard navbar-expand-lg fixed-top navbar-dark navbar-glass-shadow" data-navbar-darken-on-scroll="data-navbar-darken-on-scroll" >
               <div className="container">
                  <a className="text-white-2 dark__text-white-2 navbar-brand" href="/">algocloud</a><button type="button" aria-label="Toggle navigation" className="navbar-toggler collapsed"><span className="navbar-toggler-icon"></span></button>
