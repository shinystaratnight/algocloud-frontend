  ...
  return (
    <Wrapper className="screenshot" >      
      ...
      <Content className="screenshot-2">
             <Logo>
             <a className="navbar-brand" href="."><h1 className="logo-font"><strong>Algo</strong>Cloud</h1><svg className="svg-logo" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 16 16">
