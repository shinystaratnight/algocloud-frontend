        ...
        <div id='search-box' className='search-box'>
            <div className='d-flex'>
              <input ref={wrapperRef} type='search' className='crayons-header--search-input crayons-textfield' placeholder='Search by Asset Name/Asset ID/Asset Unit'
                ...
                style={{     height: '40px', textOverflow: 'ellipsis', width: '100%', paddingLeft: '1rem', paddingRight: '1rem', lineHeight: '2.2', borderTopLeftRadius: `${isSearched ? '1.2rem' : '50rem'}`, borderBottomLeftRadius: `${isSearched ? '0rem' : '50rem'}`, borderTopRightRadius: '0rem', borderBottomRightRadius: '0rem' }} />
